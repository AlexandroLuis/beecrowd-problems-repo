<?php
	...
	if($_POST['admkey'] == '01f3357c01bbdc4e7b9a034300f43a0d'){
		...
		echo"<script language='javascript' type='text/javascript'> alert('Insira sua chave de desenvolvedor');window.location.href='index.php'</script>";
